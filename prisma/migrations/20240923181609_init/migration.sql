...
-- CreateIndex
CREATE UNIQUE INDEX "Grade_lavel_key" ON "Grade"("lavel");
...
-- AddForeignKey
ALTER TABLE "Attandance" ADD CONSTRAINT "Attandance_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Attandance" ADD CONSTRAINT "Attandance_lessonId_fkey" FOREIGN KEY ("lessonId") REFERENCES "Lesson"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
